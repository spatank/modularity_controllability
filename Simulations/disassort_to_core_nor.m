...
title('Nor.: Disassort. to CP.: Avg. Ctrb.', 'FontSize', 15);
...
title('Nor.: Disassort. to CP: Mod. Ctrb.', 'FontSize', 15);
xlabel('Fraction of Edges in Core', 'FontSize', 15);
...
title('Nor.: Disassort. to CP: Min. Eng.', 'FontSize', 15);
xlabel('Fraction of Edges in Core', 'FontSize', 15);
...
title('Nor.: Disassort. to CP: Q and Fraction of Edges in Core', 'FontSize', 25);
xlabel('Fraction of Edges in Core', 'FontSize', 15);
