...
title('Geom.: Disassort. to Assort: Mod. Ctrb.', 'FontSize', 15);
xlabel('Fraction of Edges in Modules', 'FontSize', 15);
...
title('Geom.: Disassort. to Assort: Min. Eng.', 'FontSize', 15);
xlabel('Fraction of Edges in Modules', 'FontSize', 15);
...
title('Geom.: Disassort. to Assort.: Q and Fraction of Edges in Modules', 'FontSize', 25);
